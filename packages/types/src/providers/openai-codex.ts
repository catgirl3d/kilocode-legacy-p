...
export const openAiCodexModels = {
	...
	"gpt-5.2-codex": {
		...
		outputPrice: 0,
		supportsTemperature: false,
		description: "GPT-5.2 Codex: OpenAI's advanced coding model via ChatGPT subscription",
	},
	"gpt-5.3-codex": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		outputPrice: 0,
		supportsTemperature: false,
		description: "GPT-5.3 Codex: OpenAI's advanced coding model via ChatGPT subscription",
	},
	"gpt-5.4": {
		maxTokens: 128000,
